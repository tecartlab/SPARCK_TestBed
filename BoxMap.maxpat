...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 279.0, 63.0, 180.0, 36.0 ],
									"varname" : "Model",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 279.0, 123.0, 242.0, 266.0 ],
...
, 			{
				"name" : "settings.xml",
				"bootpath" : "/Volumes/Ddrive/04_projects/I.A[projects]/1508_SPARCK/00_projects/_testbed/_settings/_project/_BoxMap",
				"patcherrelativepath" : "./_settings/_project/_BoxMap",
				"type" : "TEXT",
				"implicit" : 1
			}
 ],
