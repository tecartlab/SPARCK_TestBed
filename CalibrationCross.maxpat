...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 41.0, 9.0, 242.0, 229.0 ],
...
, 			{
				"name" : "bs.props.CalibrationCross.p.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/ossia",
				"patcherrelativepath" : "../../01_dev/app_sparck/sparck/patchers/nodes/ossia",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "settings.xml",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/00_projects/_testbed/_settings/_project/_CalibrationCross",
				"patcherrelativepath" : "./_settings/_project/_CalibrationCross",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
