...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 20.0, 355.0, 180.0, 36.0 ],
									"varname" : "Viewport",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 20.0, 430.0, 180.0, 36.0 ],
									"varname" : "Output_1",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 245.0, 5.0, 242.0, 529.0 ],
									"varname" : "FaceStream",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 536.0, 28.0, 242.0, 351.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 38.0, 194.0, 180.0, 36.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 38.0, 128.0, 180.0, 36.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 34.0, 73.0, 180.0, 36.0 ],
									"varname" : "Output",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 20.5, 282.0, 47.0, 22.0 ],
									"text" : "pak s s"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 6,
									"outlettype" : [ "", "", "", "", "", "" ],
									"patching_rect" : [ 20.5, 244.0, 103.0, 22.0 ],
...
,
									"patching_rect" : [ 34.0, 37.0, 61.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-15::obj-34::obj-99::obj-12::obj-47::obj-20::obj-72" : [ "toggle[13]", "toggle", 0 ],
...
, 			{
				"name" : "bs.props.FaceStream.p.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/ossia",
				"patcherrelativepath" : "../../01_dev/app_sparck/sparck/patchers/nodes/ossia",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "settings.xml",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/00_projects/_testbed/_settings/_project/_FaceStream",
				"patcherrelativepath" : "./_settings/_project/_FaceStream",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
