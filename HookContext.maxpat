...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 290.0, 17.0, 242.0, 229.0 ],
									"varname" : "Hook",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 14.0, 38.0, 242.0, 270.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 579.0, 266.0, 56.0, 22.0 ],
									"restore" : 									{
										"text3d" : [ "Hooking", "up", "Jitter", "objects", "into", "sparck", "contexts?", "Yes", "\u002c", "thats", "possible." ]
									}
,
									"text" : "autopattr",
									"varname" : "u770013129"
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 342.0, 266.0, 230.0, 35.0 ],
									"text" : "Hooking up Jitter objects into sparck contexts? Yes, thats possible.",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 290.0, 315.0, 270.0, 22.0 ],
									"text" : "jit.gl.text @color 1 1 1 1 @fontsize 20 @mode 3d"
								}
...
, 			{
				"name" : "settings.xml",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/00_projects/_testbed/_settings/_project/_HookContext",
				"patcherrelativepath" : "./_settings/_project/_HookContext",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
