...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 17.0, 13.0, 180.0, 36.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 25.0, 30.0, 163.0, 130.0 ],
									"varname" : "Grid",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 220.0, 13.0, 242.0, 466.0 ],
									"varname" : "Material",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 470.0, 13.0, 242.0, 630.0 ],
									"varname" : "Model",
									"viewvisibility" : 1
								}
...
, 			{
				"name" : "bs.props.Material.p.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/Sparck2/patchers/nodes/ossia",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "bs.props.Model.p.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/Sparck2/patchers/nodes/ossia",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "settings.xml",
				"bootpath" : "D:/03_personal/MartinFroehlich/Sparck_TestBed/_settings/_project/_Material",
				"patcherrelativepath" : "./_settings/_project/_Material",
				"type" : "TEXT",
				"implicit" : 1
			}
 ],
