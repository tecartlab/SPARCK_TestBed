...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 257.0, 122.0, 242.0, 329.0 ],
									"varname" : "PointCloud",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 30.0, 122.0, 180.0, 36.0 ],
									"varname" : "Viewport",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 21.0, 25.0, 180.0, 36.0 ],
									"varname" : "Output",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 257.0, 15.0, 180.0, 36.0 ],
									"varname" : "Grid",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 257.0, 66.0, 180.0, 36.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-6::obj-34::obj-99::obj-12::obj-47::obj-20::obj-72" : [ "toggle", "toggle", 0 ],
			"parameterbanks" : 			{
...
, 			{
				...
				"patcherrelativepath" : "../../01_dev/app_sparck/sparck/patchers/nodes/ossia/_onlyOSX",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../01_dev/app_sparck/sparck/patchers/ossia/syphon",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "bs.props.ShaderPointCloud.p.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/ossia/shaders",
				"patcherrelativepath" : "../../01_dev/app_sparck/sparck/patchers/nodes/ossia/shaders",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "settings.xml",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/00_projects/_testbed/_settings/_project/_PointCloud",
				"patcherrelativepath" : "./_settings/_project/_PointCloud",
				"type" : "TEXT",
				"implicit" : 1
			}
 ],
