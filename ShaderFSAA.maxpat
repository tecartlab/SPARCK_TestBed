...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"lockedsize" : 0,
									"maxclass" : "bpatcher",
									"name" : "bs.node.ShaderFSAA.maxpat",
									"numinlets" : 4,
									"numoutlets" : 4,
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "jit_gl_texture", "jit_gl_texture", "" ],
									"patching_rect" : [ 231.0, 197.0, 242.0, 66.0 ],
									"varname" : "ShdrFSAA",
									"viewvisibility" : 1
								}
...
, 			{
				"name" : "bs.props.ShaderFSAA.p.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/ossia/shaders",
				"patcherrelativepath" : "../../01_dev/app_sparck/sparck/patchers/nodes/ossia/shaders",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "settings.xml",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/00_projects/_testbed/_settings/_project/_ShaderFSAA",
				"patcherrelativepath" : "./_settings/_project/_ShaderFSAA",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
