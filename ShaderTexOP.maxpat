...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 576.0, 116.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 418.0, 16.0, 61.0, 22.0 ],
					"text" : "savebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 352.0, 17.0, 63.0, 22.0 ],
					"text" : "closebang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 18.0, 43.0, 20.0 ],
					"rounded" : 5.0,
					"text" : "relax",
					"usebgoncolor" : 1,
					"usetextovercolor" : 1
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.0, 116.0, 200.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 203.75, 11.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 35.0, 118.0, 69.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 501.0, 7.0, 242.0, 126.0 ],
									"varname" : "DrawMask",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "jit_gl_texture", "", "" ],
									"patching_rect" : [ 250.0, 166.0, 242.0, 170.0 ],
									"varname" : "ShdrOP",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "jit_gl_texture", "", "" ],
									"patching_rect" : [ 250.0, 12.0, 242.0, 106.0 ],
									"varname" : "Texture",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 270.666666666666629, 358.0, 180.0, 36.0 ],
									"varname" : "Canvas",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 22.0, 19.0, 180.0, 36.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 64.0, 54.0, 163.0, 130.0 ],
									"varname" : "Grid",
									"viewvisibility" : 1
								}
...
,
					"patching_rect" : [ 125.0, 118.0, 80.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "int", "" ],
					"patching_rect" : [ 35.0, 51.0, 694.0, 54.320755004882812 ],
					"presentation" : 1,
					"presentation_rect" : [ 200.0, 55.0, 499.0, 50.320755004882812 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 382.0, 113.16037799999998, 382.5, 113.16037799999998 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 719.5, 111.660377502441406, 585.5, 111.660377502441406 ],
					"source" : [ "obj-1", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 3 ],
					"midpoints" : [ 382.5, 148.0, 558.5, 148.0, 558.5, 40.0, 550.75, 40.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 4 ],
					"midpoints" : [ 585.5, 151.0, 738.5, 151.0, 738.5, 40.0, 719.5, 40.0 ],
					"source" : [ "obj-8", 0 ]
				}
		...
		"parameters" : 		{
			...
			"obj-2::obj-1::obj-10::obj-99::obj-12::obj-47::obj-20::obj-72" : [ "toggle[2]", "toggle", 0 ],
			"obj-2::obj-3::obj-99::obj-12::obj-47::obj-20::obj-72" : [ "toggle", "toggle", 0 ],
			"obj-2::obj-7::obj-32::obj-38::obj-12::obj-47::obj-20::obj-72" : [ "toggle[3]", "toggle", 0 ],
			"parameterbanks" : 			{
...
, 			{
				"name" : "bs.props.Texture.p.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/ossia",
				"patcherrelativepath" : "../../01_dev/app_sparck/sparck/patchers/nodes/ossia",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "bs.props.ShaderTexOP.p.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/ossia/shaders",
				"patcherrelativepath" : "../../01_dev/app_sparck/sparck/patchers/nodes/ossia/shaders",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "bs.props.DrawMask.p.maxpat",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/01_dev/app_sparck/sparck/patchers/nodes/ossia",
				"patcherrelativepath" : "../../01_dev/app_sparck/sparck/patchers/nodes/ossia",
				"type" : "JSON",
				"implicit" : 1
...
, 			{
				"name" : "settings.xml",
				"bootpath" : "~/Arbeiten/01_projekte/150816_SPARCK/00_projects/_testbed/_settings/_project/_ShaderTexOP",
				"patcherrelativepath" : "./_settings/_project/_ShaderTexOP",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
