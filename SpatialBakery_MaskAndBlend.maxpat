...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 436.0, 6.0, 242.0, 630.0 ],
...
, 											{
												"box" : 												{
													...
													"offset" : [ 0.0, 0.0 ],
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 45.0, 83.0, 242.0, 596.0 ],
													"varname" : "Canvas_1",
													"viewvisibility" : 1
												}
...
, 			{
				"name" : "settings.xml",
				"bootpath" : "/Volumes/Ddrive/04_projects/I.A[projects]/1508_SPARCK/00_projects/_testbed/_settings/_project/_SpatialBakery_MaskAndBlend",
				"patcherrelativepath" : "./_settings/_project/_SpatialBakery_MaskAndBlend",
				"type" : "TEXT",
				"implicit" : 1
			}
 ],
